...
STATE = nest.Create("iaf_psc_alpha", 5 * 24, {"I_e": 130.0})
V = nest.Create("iaf_psc_alpha", 40, {"I_e": 30.0})
POLICY = nest.Create("iaf_psc_alpha", 500, {"I_e": 30.0})
...
spike_recorders_1_4 = connect_WTA(POLICY)
spike_recorders_5_8 = connect_WTA(POLICY)
